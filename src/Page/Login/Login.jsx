...
const Login = () => {
  ...
  return (
    <>
      ...
      >
        <div className="lg:flex w-11/12  lg:h-full items-center justify-center mx-auto rounded-lg">
          ...
          <div className=" flex h-[70vh]  lg:h-5/6 w-full lg:w-3/5	 items-center justify-center  bg-white bg-opacity-50 p-8">
